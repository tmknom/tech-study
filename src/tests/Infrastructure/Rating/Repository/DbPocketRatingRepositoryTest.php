...
class DbPocketRatingRepositoryTest extends TestCase
{

    /** @var DbPocketRatingRepository */
    private $sut;
    ...
    public function setUp()
    {
        ...
        // テスト対象のオブジェクト作成
        $this->sut = new DbPocketRatingRepository();
    }
    ...
    public function save_正常系()
    {
        ...
        // 事前準備
        $ratingCount = new PocketCount(800);
        ...
        // 確認
        $this->assertEquals(new PocketCount(800), $actual);
    }
     ...
     * @expectedException InvalidArgumentException
     */
    public function save_異常系_PocketCount以外が引数に渡された場合()
    {
        // 事前準備
